...
Creation Date: 02/03/2022 Date of Last Modification: 02/14/2022
...
INSERT INTO petstore.customer
VALUES ('101', '(123) 456-7890', 'Justin', 'Dubin', '1276 Gilbreath Dr', '37614', '9999');

-- B2. New animal added to database
INSERT INTO petstore.animal (name, breed, dateborn, gender, color, listprice)
VALUES ('Pickles', 'Scottish Fold', '03-MAR-20', 'Male', 'Gray', '112.5');

-- B3. New merchandise order added to database
INSERT INTO petstore.merchandiseorder (orderdate, receivedate, supplierid, employeeid)
VALUES ('02-FEB-22', '10-FEB-22', '14', '3');
